                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                           ...
                           Version 2.0, in my dream visi, it have a Dashboard login for add embed Youtube easyly..<br /><br />add sum for my spirit to coding, $USD 2,543= $2 dollar 43 cents for continue all device of cars, but my time is tiny..<br /><br />
                        <p>2022 - ';
                        ?>
                        <?php echo date("Y"); ?>
                        <?php
