<?php
//Source Code:UNKNOWN, maybe stackoverflow
//Copyright [2021] [Parlindungan Isa Anshory Siregar]
...
$IP043="103.16.79.x";
//
if (($brow01==$brows01 AND $os01==$OS01) OR ($brow01==$brows02 AND $os01==$OS01) OR ($brow01==$brows02 AND $os01==$OS02) OR ($os01==$OS06))
{
echo "<! DOCTYPE html>";
echo '<html lang="en">';
echo '<head>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div>@pias25<br />127.0.0.1 --- <a href="mailto:l3modz.microsoft@gmail.com">l3modz.microsoft@gmail.com</a>
                    </div>
                    <br />
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <img width="813" height="457" src="image/ps4/Gran%20Turismo®SPORT_20211106225531.jpg" title="GTSport">
                        <p>2021 - ';?><?php echo date("Y"); ?><?php echo'</p>
						</div>
                        </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                           ...
                           Version 2.0, in my dream visi, it have a Dashboard login for add embed Youtube easyly..<br /><br />add sum for my spirit to coding, $USD 4.325= 4 dollar 325 cents for continue all device of cars, but my time is tiny..<br /><br />
                        <p>2022 - ';
                        ?>
                        <?php echo date("Y"); ?>
                        <?php
...
if (($brow01==$brows01 AND $os01==$OS03) OR ($brow01==$brows02 AND $os01==$OS03) OR ($brow01==$brows01 AND $os01==$OS01) OR ($brow01==$brows04 AND $os01==$OS01) OR ($os01==$OS05) OR ($os01==$OS04) OR ($os01==$OS07) OR ($os01==$OS08) )
{
echo "<! DOCTYPE html>";
echo '<html lang="en">';
echo '<head>
...
echo'
    <meta name="robots" content="index, follow">';
echo "<center>Situs Desktop Version<br />atau<br />Download Firefox<br />";
echo "<a href=\"https://www.mozilla.org/en-US/firefox/browsers/\" target=\"_blank\"><img src=\"https://www.mozilla.org/media/protocol/img/logos/firefox/browser/developer/logo-lg-high-res.8aedc8028e4d.png\">";
echo "</center>";
}
?>
